"""Research unscented Kalman filter for phase-lag tracking."""
...
class PassiveRFUKF:
    ...
    def predict(self) -> np.ndarray:
        ...
        for weight, point in zip(self._wc, points, strict=True):
    ...
    def step(self, observation: RFObservation) -> Estimate:
        ...
        for weight, point, value in zip(self._wc, sigma_points, predicted, strict=True):
