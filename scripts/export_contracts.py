...
from generate_wire_models import SPECIFICATIONS, check_generated_source
...
def check_cross_field_rules(schema: dict[str, object]) -> None:
    ...
    if "allOf" not in measurement:
        raise ValueError("Measurement must encode observable and phase-baseline rules")
