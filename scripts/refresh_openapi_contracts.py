...
from dart.api.openapi import OpenApiDocument, runtime_openapi
from dart.api.optimizer import app as solver_app
from dart.api.postprocessor import app as postprocessor_app

ROOT = Path(__file__).resolve().parents[1]
OPENAPI_ROOT = ROOT / "contracts" / "openapi"
APPLICATIONS = (
    (OPENAPI_ROOT / "orchestrator-v0.1.json", gateway_app),
